...
public abstract class ChessGamePiece {
    ...
    public boolean isEnemy( ChessGameBoard board, int row, int col ){
        ...
        return this.getColorOfPiece() == ChessGamePiece.WHITE ? enemyPiece.getColorOfPiece() == ChessGamePiece.BLACK : enemyPiece.getColorOfPiece() == ChessGamePiece.WHITE;        
    }
    // ----------------------------------------------------------
    /**
    ...
    public ImageIcon createImageByPieceType() {
		...
		icons_map.put(ChessGamePiece.BLACK, "chessImages/Black" + getPieceName() + ".gif");
		icons_map.put(ChessGamePiece.WHITE, "chessImages/White" + getPieceName() + ".gif");
